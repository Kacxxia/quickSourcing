...
import { signUp, signIn, updateToken, sendResetPasswordCaptcha, test, resetPassword, validateCaptcha, cookieSignInGetInfo } from './controller/auth'
...
module.exports = (app) => {
    ...
    apiRoutes.get('/auth', jwtAuth, cookieSignInGetInfo)
